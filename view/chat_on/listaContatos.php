...
require "../control/controlG.php";
//include '../../control/controlUsuario.php';
///include '../../control/controlGrupoUsuario.php';
...
<script type="text/javascript" src="../view/chat_on/js/functions.js"></script>
<script type="text/javascript" src="../view/chat_on/js/chat.js"></script>
</head>
